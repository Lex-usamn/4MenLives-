...
@app.route('/api/streaming/obs/config')
def get_obs_config():
    ...
    obs_config = {
        ...
        "multicast_outputs": [
            {
                ...
                "settings": {
                    ...
                    "key": "SEU_STREAM_KEY_TWITCH",
                    "use_auth": False
                },
                "platform": "twitch",
                "enabled": platforms_data['twitch']['connected']
            },
            {
                "name": "YouTube Stream",
                "type": "rtmp_output",
                "settings": {
                    ...
                    "key": "SEU_STREAM_KEY_YOUTUBE",
                    "use_auth": False
                },
                "platform": "youtube",
                "enabled": platforms_data['youtube']['connected']
            },
            {
                ...
                "settings": {
                    ...
                    "key": "SEU_STREAM_KEY_FACEBOOK",
                    "use_auth": False
                },
                "platform": "facebook",
                "enabled": platforms_data['facebook']['connected']
            },
            {
                ...
                "settings": {
                    ...
                    "key": "SEU_STREAM_KEY_INSTAGRAM",
                    "use_auth": False
                },
                "platform": "instagram",
                "enabled": platforms_data['instagram']['connected']
            }
        ],
        ...
        "setup_instructions": [
            ...
            "3. Para streaming simultâneo, instale o plugin 'Multiple RTMP outputs'",
            "4. Configure cada plataforma como um output separado",
            "5. Use as URLs e chaves fornecidas acima",
            "6. Teste cada conexão antes de iniciar a transmissão"
        ],
        "plugin_info": {
            "name": "Multiple RTMP outputs",
            "description": "Plugin para transmitir simultaneamente para múltiplas plataformas",
            "download_url": "https://obsproject.com/forum/resources/multiple-rtmp-outputs-plugin.964/",
            "installation": "Baixe e instale o plugin para habilitar multicast"
        },
        "platform_guides": {
            "twitch": {
                "stream_key_location": "Twitch Creator Dashboard > Configurações > Stream",
                "rtmp_url": "rtmp://live.twitch.tv/live/",
                "notes": "Use sua chave de stream do Twitch"
            },
            "youtube": {
                "stream_key_location": "YouTube Studio > Transmitir ao vivo > Configurar",
                "rtmp_url": "rtmp://a.rtmp.youtube.com/live2/",
                "notes": "Ative transmissões ao vivo no seu canal"
            },
            "facebook": {
                "stream_key_location": "Facebook Creator Studio > Transmitir ao vivo",
                "rtmp_url": "rtmps://live-api-s.facebook.com:443/rtmp/",
                "notes": "Use RTMPS (seguro) para Facebook"
            },
            "instagram": {
                "stream_key_location": "Instagram Creator Studio > Transmitir ao vivo",
                "rtmp_url": "rtmps://live-upload.instagram.com:443/rtmp/",
                "notes": "Disponível apenas para contas verificadas"
            }
        }
    }
